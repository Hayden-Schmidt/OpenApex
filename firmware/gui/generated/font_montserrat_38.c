...
//
// Montserrat-Medium 38px, subsetted to: '0123456789'
// odometer whole-km digits, set one character at a time.
//
...
// lv_font_montserrat_38 ({'line_height': 41, 'base_line': 7, 'cap_height': 27, 'x_height': 20}) so that subsetting cannot move any label.
/*******************************************************************************
 * Size: 38 px
 * Bpp: 4
 * Opts: --no-compress --no-prefilter --force-fast-kern-format --bpp 4 --size 38 -r <see below>
 ******************************************************************************/
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 0, .adv_w = 406, .box_w = 23, .box_h = 26, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 299, .adv_w = 225, .box_w = 11, .box_h = 26, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 442, .adv_w = 349, .box_w = 21, .box_h = 26, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 715, .adv_w = 348, .box_w = 21, .box_h = 26, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 988, .adv_w = 407, .box_w = 24, .box_h = 26, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 1300, .adv_w = 349, .box_w = 21, .box_h = 26, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 1573, .adv_w = 375, .box_w = 22, .box_h = 26, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 1859, .adv_w = 364, .box_w = 21, .box_h = 26, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 2132, .adv_w = 392, .box_w = 22, .box_h = 26, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 2418, .adv_w = 375, .box_w = 21, .box_h = 26, .ofs_x = 1, .ofs_y = 0}
};
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t gui_font_montserrat_38 = {
#else
lv_font_t gui_font_montserrat_38 = {
#endif
