...
//
// Montserrat-Medium 44px, subsetted to: '0123456789:- apm'
// idle clock 'HH:MM' / '--:--', same 12h insurance as size 28.
//
...
// lv_font_montserrat_44 ({'line_height': 49, 'base_line': 9, 'cap_height': 31, 'x_height': 23}) so that subsetting cannot move any label.
/*******************************************************************************
 * Size: 44 px
 * Bpp: 4
 * Opts: --no-compress --no-prefilter --force-fast-kern-format --bpp 4 --size 44 -r <see below>
 ******************************************************************************/
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 3772, .adv_w = 421, .box_w = 21, .box_h = 24, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 4024, .adv_w = 744, .box_w = 39, .box_h = 24, .ofs_x = 4, .ofs_y = 0},
    {.bitmap_index = 4492, .adv_w = 480, .box_w = 25, .box_h = 33, .ofs_x = 4, .ofs_y = -9}
};
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t gui_font_montserrat_44 = {
#else
lv_font_t gui_font_montserrat_44 = {
#endif
